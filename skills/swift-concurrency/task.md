...
timestamp: 2026-08-11T06:08:56.125Z
---
...
- [hasActiveCancellationShield](/documentation/swift/task/hasactivecancellationshield) Checks if the current task is executing in a scope with a task cancellation shield activated by the `withTaskCancellationShield(operation:)-(()->Value)` function.
